...
#define ADDW(n)                                                                           \
	{                                                                                     \
		...
		F = (F & (FZ)) | (FH & ((H ^ ((n) >> 8) ^ HB(acc)) << 1)) | (acc.b[HI][LO] << 4); \
		HL = W(acc);                                                                      \
	}
...
#define ADDSP(n)                                                                     \
	{                                                                                \
		...
		F = (FH & (((SP >> 8) ^ ((n) >> 8) ^ HB(acc)) << 1)) | (acc.b[HI][LO] << 4); \
		SP = W(acc);                                                                 \
	}
...
#define CP(n)                                                                                       \
	{                                                                                               \
		W(acc) = (un16)A - (un16)(n);                                                               \
		F = FN | (ZFLAG(LB(acc))) | (FH & ((A ^ (n) ^ LB(acc)) << 1)) | ((un8)(-(n8)HB(acc)) << 4); \
	}
...
#define SBC(n)                                                                                          \
	{                                                                                                   \
		W(acc) = (un16)A - (un16)(n) - (un16)((F & FC) >> 4);                                           \
		F = FN | (ZFLAG((n8)LB(acc))) | (FH & ((A ^ (n) ^ LB(acc)) << 1)) | ((un8)(-(n8)HB(acc)) << 4); \
		A = LB(acc);                                                                                    \
	}
